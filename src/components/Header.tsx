...
export function Header() {
  ...
  return (
    ...
    //     <h1 className="btn btn-ghost btn-sm rounded-btn">
    //       {chainId == 80001 ? "The Ohana Development Marketplace" : "The Ohana Development Marketplace"}
    //     </h1>
    //     &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    //     <Link href="/">
    //       <h1 style={style} className="btn btn-ghost btn-sm rounded-btn">
    //         Marketplace
    //       </h1>
    //     </Link>
    //     &nbsp;&nbsp;
