...
const values = [
  {
    name: "Villa Ekaho",
    description: "",
    image_https: "https://ohana-hills.com/wp-content/w3-webp/uploads/2021/06/ekahi-1.jpegw3.webp",
...
export function addNFT(name, description, image_https, image_ipfs, tokenId) {
  ...
  const tokenContract = new Web3EthContract(
    values[values.length - 1].contract.abi,
    values[values.length - 1].contract.address
  );
